      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="relative aspect-square rounded-lg overflow-hidden bg-black">
            ...
            >
              <source 
                src={import.meta.env.DEV ? '/assets/ai-architecture/flesh_digression.mp4' : '/assets/ai-architecture/flesh_digression.mp4'}
                type="video/mp4"
              />
            </video>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-8">
            ...
            <Card>
              ...
              <CardContent>
                <img 
                  src="/assets/ai-architecture/real-collage.jpg" 
          ...
          <div className="space-y-8">
            ...
            <Card>
              ...
              <CardContent>
                <img 
                  src="/assets/ai-architecture/generated-collage.png" 

...
describe('livestream pipeline explanation',()=>{
  it('shows every step explanation immediately and keeps them visible during selection',()=>{
    render(<InkProcess/>);
    ...
    expect(screen.getByText('HLS playlist → compressed source segment')).toBeVisible();
  });
